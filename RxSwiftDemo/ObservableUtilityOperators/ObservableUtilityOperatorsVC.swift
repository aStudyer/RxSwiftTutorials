//
//  ObservableUtilityOperatorsVC.swift
//  RxSwiftDemo
//
...
class ObservableUtilityOperatorsVC: BaseTableViewController {
    override func viewDidLoad() {
        super.viewDidLoad()
        tableView.tableFooterView = UIView()
    }
}
extension ObservableUtilityOperatorsVC {
    ...
    */
    ...
    private func timeout() {
        ...
        Observable.from(times)
            .flatMap { item in
                return Observable.of(item[0]["value"]!)
                    .delaySubscription(item[0]["time"]!, scheduler: MainScheduler.instance)
            }
